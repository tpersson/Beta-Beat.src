...
#     ty = fig.add_subplot(2,2,4)
    ...
    tx.set(xlabel=('X Plane - Frequency [1/turn]'), ylabel=('Normalized amplitude'), xlim=([0., .5]), ylim=([1e-5, 1]))
    ty.set(xlabel=('Y Plane - Frequency [1/turn]'), ylabel=('Normalized amplitude'), xlim=([0., .5]), ylim=([1e-5, 1]))
#     tx.grid(which='both', linewidth=.1, linestyle='dotted', color='black')
#     ty.grid(which='both', linewidth=.1, linestyle='dotted', color='black')
...
#     tx.set_color_cycle(['r','b', 'g', 'm'])#  '#FF0000', '#FF8000', '#0000FF','black', '#00FF00', '#FF00FF', '#01DFD7' ,'#0080FF',  '#8000FF', '#DF0174'])
#     ty.set_color_cycle(['r','b', 'g', 'm'])#  '#FF0000', '#FF8000', '#0000FF','black', '#00FF00', '#FF00FF', '#01DFD7' ,'#0080FF',  '#8000FF', '#DF0174'])

    ''' SET FIGURE 2'''
    # fig2 = plt.figure(figsize=(24,8))
    # fig2.patch.set_facecolor('white')
    # fig2.suptitle('Initial Positions')
    # ax = fig2.add_subplot(1,3,1)
    # ay = fig2.add_subplot(1,3,2)
    # az = fig2.add_subplot(1,3,3)
    # ax.set(xlabel='X kick [mm]', ylabel='PX', xlim=([0., 5]))
    # ay.set(xlabel='Y kick [mm]', ylabel='PY', xlim=([0., 5]))
    # az.set(xlabel='X kick [mm]', ylabel='Y kick [mm]', xlim=([0., 5]), ylim=([0., 5]))
    # ax.grid(which='both', linewidth=.1, linestyle='-', color='grey')
    # ay.grid(which='both', linewidth=.1, linestyle='-', color='grey')
    # az.grid(which='both', linewidth=.1, linestyle='-', color='grey')
    # ax.set_color_cycle(['#FF0000', '#FF8000', '#0000FF','black', '#00FF00', '#FF00FF', '#01DFD7' ,'#0080FF',  '#8000FF', '#DF0174'])
    # ay.set_color_cycle(['#FF0000', '#FF8000', '#0000FF','black', '#00FF00', '#FF00FF', '#01DFD7' ,'#0080FF',  '#8000FF', '#DF0174'])
    # az.set_color_cycle(['#FF0000', '#FF8000', '#0000FF','black', '#00FF00', '#FF00FF', '#01DFD7' ,'#0080FF',  '#8000FF', '#DF0174'])
...
#             n_label= ['all off',  '1000x mco val', '2000x mco val', '5000x mco val']
            n_label = ['Fringe-fields on', 'Fringe-fields off']    
...
## FRINGE TEST ##
    sdds_models         = [
                           '/afs/cern.ch/work/f/fcarlier/public/Beta-Beat.src/analysisCode/multiParticleSimulation/final_fringe_test/true/fringe_true.sdds',
                            '/afs/cern.ch/work/f/fcarlier/public/Beta-Beat.src/analysisCode/multiParticleSimulation/final_fringe_test/false/fringe_false.sdds'
                           ]
...
#     sdd
    ...
    plot_single_BPM_data(bpm_name='BPM.33R6.B2', sdds_model=sdds_models, sdds_experimental=sdds_experimental, output_file=output_file_path, SUSSIX = False  )